    ...
    <section class="bg-darkGrey relative py-[70px]">
      <div class="container">
        ...
        <div class="flex items-center gap-5 lg:justify-between">
          <!-- Form Card -->
          <form action="<?php echo e(route('front.payment.update', $booking->id)); ?>" method="POST"
              ...
              <div class="flex flex-col gap-4">
                ...
                <div class="flex items-center justify-between">
                  ...
                  <p class="text-base font-semibold">
                    <?php echo e($booking->item->brand->name); ?> <?php echo e($booking->item->name); ?>
                ...
                <div class="flex items-center justify-between">
                  ...
                  <p class="text-base font-semibold">
                    <?php echo e($booking->start_date->diffInDays($booking->end_date)); ?> days
                  </p>
                </div>
                <!-- Items -->
                <div class="flex items-center justify-between">
                ...
                <div class="flex items-center justify-between">
                  ...
                  <p class="text-base font-semibold">
                    $<?php echo e($booking->item->price); ?> per day
                  </p>
                </div>
                <!-- Items -->
                <div class="flex items-center justify-between">
                  ...
                  <p class="text-base font-semibold">
                    $<?php echo e($booking->item->price * $booking->start_date->diffInDays($booking->end_date) * (10 / 100)); ?>
...
<?php endif; ?><?php /**PATH C:\laragon\www\vrom_AhmadRidhoniBaru\resources\views/payment.blade.php ENDPATH**/ ?>