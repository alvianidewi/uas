        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-[29px]">
          <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="card-popular">
              ...
              <img src="<?php echo e($item->thumbnail); ?>" class="rounded-[18px] min-w-[216px] w-full h-[150px]" alt="">
              <div class="flex items-center justify-between gap-1">
                <!-- Price -->
                <p class="text-sm font-normal text-secondary">
                  <span class="text-base font-bold text-primary">$<?php echo e($item->price); ?></span>/day
                </p>
                <!-- Rating -->
...
<?php endif; ?><?php /**PATH C:\laragon\www\vrom_AhmadRidhoniBaru\resources\views/landing.blade.php ENDPATH**/ ?>