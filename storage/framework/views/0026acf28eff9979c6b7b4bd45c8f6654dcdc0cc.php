...
<?php $component->withAttributes([]); ?>
     ...
     <?php $__env->slot('header', null, []); ?> 
      <h2 class="text-xl font-semibold leading-tight text-gray-800">
        ...
        <?php echo __('Booking &raquo; Sunting &raquo; #') . $booking->id . ' &middot; ' . $booking->name; ?>
    ...
    <div class="py-12">
      <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div>
          ...
          <?php endif; ?>
          <form class="w-full" action="<?php echo e(route('admin.booking.update', $booking->id)); ?>" method="post"
            ...
            <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
              <div class="w-full">
                ...
                <input value="<?php echo e(old('name') ?? $booking->name); ?>" name="name"
            ...
            <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
              <div class="w-full">
                ...
                <input value="<?php echo e(old('address') ?? $booking->address); ?>" name="address"
                       class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                       id="grid-last-name" type="text" placeholder="Nama">
                <div class="mt-2 text-sm text-gray-500">
            ...
            <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
              <div class="w-full">
                ...
                <input value="<?php echo e(old('city') ?? $booking->city); ?>" name="city"
                       class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                       id="grid-last-name" type="text" placeholder="Nama">
                <div class="mt-2 text-sm text-gray-500">
            ...
            <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
              <div class="w-full">
                ...
                <input value="<?php echo e(old('zip') ?? $booking->zip); ?>" name="zip"
                       class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                       id="grid-last-name" type="text" placeholder="Nama">
                <div class="mt-2 text-sm text-gray-500">
            ...
            <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
              <div class="w-full">
                ...
                <select name="payment_status"
                  ...
                  <option value="success" <?php echo e($booking->payment_status == 'success' ? 'selected' : ''); ?>>Success
                  </option>
                  <option value="failed" <?php echo e($booking->payment_status == 'failed' ? 'selected' : ''); ?>>Failed</option>
                  <option value="expired" <?php echo e($booking->payment_status == 'expired' ? 'selected' : ''); ?>>Expired</option>
                </select>
                <div class="mt-2 text-sm text-gray-500">
...
<?php endif; ?><?php /**PATH C:\laragon\www\vrom_AhmadRidhoniBaru\resources\views/admin/bookings/edit.blade.php ENDPATH**/ ?>