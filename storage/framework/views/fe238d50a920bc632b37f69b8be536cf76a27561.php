    ...
    <div class="py-12">
      <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div>
          ...
          <?php endif; ?>
          <form class="w-full" action="<?php echo e(route('admin.items.store')); ?>" method="post" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\vrom_AhmadRidhoniBaru\resources\views/admin/items/create.blade.php ENDPATH**/ ?>